...
<body>
    ...
    <div class="login-container">
        ...
        <form action="proses_login_ramdan.php" method="POST">
            <div class="input-group">
                <label>Username</label>
                <input type="text" name="username_ramdan" placeholder="Masukkan username Anda..." required autocomplete="off">
            </div>
            <div class="input-group">
                <label>Password</label>
                <input type="password" name="password_ramdan" placeholder="Masukkan password Anda..." required>
            </div>
