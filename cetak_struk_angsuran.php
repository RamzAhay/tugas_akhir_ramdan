 ...
 */
$sql = "SELECT a.*, p.sisa_pinjaman, ang.nama 
...
$pdf->SetAutoPageBreak(false); // Mencegah pindah halaman otomatis jika teks panjang
$pdf->AddPage();
...
$pdf->Cell(70, 4, 'Jl. RPL No. 67, Indonesia', 0, 1, 'C');
...
// Output: Langsung tampilkan di browser (Inline)
