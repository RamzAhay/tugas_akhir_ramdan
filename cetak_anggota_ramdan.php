...
// Isi Tabel
$pdf->SetFont('Arial','',10);
$query = mysqli_query($koneksi, "SELECT * FROM tb_anggota_ramdan ORDER BY id_anggota_ramdan ASC");
$no = 1;
while($data = mysqli_fetch_assoc($query)) { 
    $pdf->Cell(10,10,$no++,1,0,'C');
    $pdf->Cell(60,10,$data['nama_ramdan'],1,0,'L');
    $pdf->Cell(80,10,$data['alamat_ramdan'],1,0,'L');
    $pdf->Cell(40,10,$data['no_hp_ramdan'],1,1,'C');
}
