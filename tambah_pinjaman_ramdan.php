...
<div class="content">
    <div class="form-container" style="max-width: 800px; margin: 0 auto; background: #fff; padding: 40px; border-radius: 20px; box-shadow: 0 10px 40px rgba(0,0,0,0.05);">
        ...
        <form action="proses_tambah_pinjaman_ramdan.php" method="POST">
            <!-- Pilih Anggota -->
            <div class="mb-4">
                <label class="form-label fw-bold text-dark mb-2">Nama Anggota Koperasi</label>
                <select name="id_anggota_ramdan" class="form-select form-select-lg border-2" required>
                    <option value="">-- Cari Nama Anggota --</option>
                    <?php
                    // Mengambil id_anggota_ramdan dan nama_ramdan dari tb_anggota_ramdan
                    $q_anggota = mysqli_query($koneksi, "SELECT id_anggota_ramdan, nama_ramdan FROM tb_anggota_ramdan ORDER BY nama_ramdan ASC");
                    while ($d = mysqli_fetch_assoc($q_anggota)) {
                        echo "<option value='".$d['id_anggota_ramdan']."'>".strtoupper($d['nama_ramdan'])."</option>";
                    }
                    ?>
                </select>
            </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-md-7 mb-3">
                    ...
                    <input type="hidden" name="jumlah_pinjaman_ramdan" id="real_rupiah">
                ...
                <div class="col-md-5 mb-3">
                    ...
                    <div class="input-group input-group-lg">
                        <input type="number" name="bunga_ramdan" class="form-control border-2" value="10" min="1" required>
            ...
            <div class="row g-4 mt-1">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select name="lama_pinjaman_ramdan" class="form-select form-select-lg border-2" required>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="date" name="tanggal_pinjaman_ramdan" class="form-control form-control-lg border-2" value="<?php echo date('Y-m-d'); ?>" required>
                </div>
            </div>
            ...
            <div class="d-grid gap-2 mt-4 pt-2">
                ...
                <a href="data_pinjaman_ramdan.php" class="btn btn-link text-muted text-decoration-none text-center">Batal dan Kembali</a>
            </div>
        </form>
    </div>
</div>
