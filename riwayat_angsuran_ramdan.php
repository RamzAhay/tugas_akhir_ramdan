...
$id_pinjaman_ramdan = mysqli_real_escape_string($koneksi, $_GET['id']);

// Ambil info detail pinjaman & nama_ramdan anggota
$q_info = mysqli_query($koneksi, "SELECT p.*, a.nama_ramdan FROM tb_pinjaman_ramdan p 
                                  JOIN tb_anggota_ramdan a ON p.id_anggota_ramdan = a.id_anggota_ramdan 
                                  WHERE p.id_pinjaman_ramdan = '$id_pinjaman_ramdan'");
...
<div class="content">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mb-0">Rincian pembayaran untuk pinjaman <span class="fw-bold text-primary"><?php echo strtoupper($d_info['nama_ramdan']); ?></span></p>
        </div>
        <div class="d-flex gap-2">
            <!-- PERUBAHAN: Mengubah href dari cetak_angsuran.php menjadi cetak_laporan_angsuran_ramdan.php -->
            <a href="cetak_laporan_angsuran_ramdan.php?id=<?php echo $id_pinjaman_ramdan; ?>" target="_blank" class="btn btn-dark shadow-sm">
                <i class="bi bi-printer me-1"></i> Cetak Laporan
            </a>
            <!-- Tombol Bayar (Disembunyikan jika lunas atau user = Anggota) -->
            <?php if($d_info['status_pinjaman_ramdan'] != 'Lunas' && $_SESSION['role'] != 'Anggota'): ?>
                <a href="tambah_angsuran_ramdan.php?id=<?php echo $id_pinjaman_ramdan; ?>" class="btn btn-success shadow-sm">
    ...
    <div class="row g-4 mb-4">
        <div class="col-md-3">
            <div class="summary-card">
                ...
                <div class="summary-value text-dark"><?php echo rupiah($d_info['total_pinjaman_ramdan']); ?></div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="summary-card">
                ...
                <?php 
                    $sudah_bayar = $d_info['total_pinjaman_ramdan'] - $d_info['sisa_pinjaman_ramdan'];
                ?>
        ...
        <div class="col-md-3">
            <div class="summary-card">
                ...
                <div class="summary-value text-danger"><?php echo rupiah($d_info['sisa_pinjaman_ramdan']); ?></div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="summary-card">
    ...
    <?php 
        $persen = ($d_info['total_pinjaman_ramdan'] > 0) ? ($sudah_bayar / $d_info['total_pinjaman_ramdan']) * 100 : 0;
    ...
    <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
        <table class="table table-hover align-middle mb-0">
            ...
            <tbody>
                ...
                $q_angsuran = mysqli_query($koneksi, "SELECT * FROM tb_angsuran_ramdan WHERE id_pinjaman_ramdan = '$id_pinjaman_ramdan' ORDER BY tanggal_bayar_ramdan ASC, id_angsuran_ramdan ASC");
                ...
                <tr>
                    ...
                    <td class="fw-bold"><?php echo tgl_indo($r['tanggal_bayar_ramdan']); ?></td>
                    <td>
                    ...
                    <td class="text-center">
                        ...
                        $metode = isset($r['metode_pembayaran_ramdan']) ? $r['metode_pembayaran_ramdan'] : 'Tunai'; 
                        if ($metode == 'Transfer') {
                    ...
                    <td class="text-end fw-bold text-success">
                        + <?php echo rupiah($r['jumlah_bayar_ramdan']); ?>
                    </td>
                    <td class="text-center pe-4">
                        <a href="cetak_struk_angsuran_ramdan.php?id=<?php echo $r['id_angsuran_ramdan']; ?>" target="_blank" class="btn btn-outline-secondary btn-sm" title="Cetak Struk">
