...
<div class="content">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted small">Rekapitulasi saldo per kategori yang diurutkan berdasarkan nama_ramdan anggota.</p>
        </div>
        <?php if ($role_user != 'Anggota'): ?>
            <div class="d-flex gap-2">
                <a href="tambah_simpanan_ramdan.php" class="btn btn-primary shadow-sm">
        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    ...
                    $sql = "SELECT a.id_anggota_ramdan, a.nama_ramdan,
                                SUM(CASE WHEN s.jenis_simpanan_ramdan = 'Pokok' THEN s.jumlah_ramdan ELSE 0 END) as total_pokok,
                                SUM(CASE WHEN s.jenis_simpanan_ramdan = 'Wajib' THEN s.jumlah_ramdan ELSE 0 END) as total_wajib,
                                SUM(CASE WHEN s.jenis_simpanan_ramdan = 'Sukarela' THEN s.jumlah_ramdan ELSE 0 END) as total_sukarela,
                                SUM(s.jumlah_ramdan) as total_semua
                            FROM tb_anggota_ramdan a
                            LEFT JOIN tb_simpanan_ramdan s ON a.id_anggota_ramdan = s.id_anggota_ramdan
                            GROUP BY a.id_anggota_ramdan, a.nama_ramdan
                            ORDER BY a.nama_ramdan ASC";
                    ...
                    <tr>
                        ...
                        <td class="fw-bold text-dark text-uppercase">
                            <?php echo htmlspecialchars($data['nama_ramdan']); ?>
                            <div class="text-muted" style="font-size: 10px; font-weight: normal;">ID: <?php echo $data['id_anggota_ramdan']; ?></div>
                        </td>
                        ...
                        <td class="text-center">
                            <a href="tarik_simpanan_ramdan.php?id_anggota_ramdan=<?php echo $data['id_anggota_ramdan']; ?>" class="btn btn-outline-danger btn-sm rounded-pill px-3" style="font-size: 12px;">
